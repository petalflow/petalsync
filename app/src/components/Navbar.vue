<template>
  ...
  const navigation = [
    { name: 'Projetos', href: '/', current: route.path === '/' },
    { name: 'Consultas', href: '#', current: route.path === '#' },
    { name: 'Logs', href: '/Log', current: route.path === '/Log' },
    { name: 'Conexões', href: '#', current: route.path === '#' },
    { name: 'Scritps', href: '#', current: route.path === '#' },
  ]
