...
class Query(Document):
    ...
    name_query = StringField(required=True, max_length=100)
...
class User(Document):
    ds_first_name = StringField(required=True, max_length=100)
    ds_last_name = StringField(required=True, max_length=100)
    ds_email = StringField(required=True, max_length=100)
    ds_password = StringField(required=True, max_length=156)
    roles = ListField(StringField(), default=[], required=True)



class ConfigStart(Document):
    verify = IntField(default=0, required=True, max_value=1)